...
<body>
    ...
    <div class="container mt-5">
        <h2 class="text-center mb-4" style="color: gray">Gerenciar Cidades</h2>
            ...
            <div class="col-md-12">
                <table class="table table-bordered table-striped" id="citiesTable">
                    ...
                    <tbody>
                        <tr class="text-center align-middle">
                            <td>1</td>
                            <td><img src="imagens/cards/foz-de-iguacu.jpg" class="mini-foto" style="
                            width: 80px;
                            height: 50px;
                            object-fit: cover;" alt="Foz de Iguaçu"></td>
                            <td>Foz de Iguaçu</td>
                        ...
                        <tr class="text-center align-middle">
                            <td>2</td>
                            <td><img src="imagens/cards/recife.jpg" class="mini-foto" style="
                            width: 80px;
                            height: 50px;
                            object-fit: cover;" alt="Recife"></td>
                            <td>Recife</td>
                        ...
                        <tr class="text-center align-middle">
                            <td>3</td>
                            <td><img src="imagens/cards/rio-de-janeiro.jpg" class="mini-foto" style="
                            width: 80px;
                            height: 50px;
                            object-fit: cover;" alt="Rio de Janeiro"></td>
